...
DEPENDENCIES = user hal system vision loc entities geometry rtxmath platform qtgui
MAKE_DEPENDENCIES = user hal system vision loc entities geometry rtxmath platform qtgui
...
# GUI
LIBS += Qt5Quick Qt5Widgets Qt5Gui Qt5Qml Qt5Network Qt5Core glut GL GLU GLEW assimp
...
LIB_DEPS += $(USER_LIB_DEP) $(VISION_LIB_DEP) $(SYSTEM_LIB_DEP) $(HAL_LIB_DEP) $(LOC_LIB_DEP) $(ENTITIES_LIB_DEP) $(GEOMETRY_LIB_DEP) $(RTXMATH_LIB_DEP) $(PLATFORM_LIB_DEP) $(QTGUI_LIB_DEP)
